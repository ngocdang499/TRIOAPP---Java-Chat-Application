...
public class AttachTagsMsg {
    ...
    public static String processAccRegistration(String _ID, String _Passwd, String _IP, String _Port) {
    ...
    public static String processRequestChatIP(User usr) {
        return Tags.CHAT_REQ_OPEN_TAG + Tags.USR_ID_OPEN_TAG + usr.getUsrID() + Tags.USR_ID_CLOSE_TAG + Tags.CHAT_REQ_CLOSE_TAG;
    }
